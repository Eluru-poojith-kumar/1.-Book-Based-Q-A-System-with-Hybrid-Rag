...
def process_pdf(pdf_file):
    ...
    return "✅ Book uploaded and processed successfully!"

# 🔍 Hybrid RAG: Retrieve Relevant Passages
...
# ✅ Generate Answers Based on Question Type (Improved Prompt Engineering)
def answer_question(question):
    best_passages = retrieve_best_passages(question, top_k=5)
    context = " ".join(best_passages)

    # 🔥 Advanced Prompt Engineering: Structured Question Handling
...
# ✅ Deploy as a Web App (Gradio)
with gr.Blocks() as iface:
    gr.Markdown("# 📚 Book-Based Q&A System with Hybrid RAG & Advanced Prompt Engineering\nUpload a PDF and ask structured questions.")

    pdf_upload = gr.File(label="📂 Upload your book (PDF)")
